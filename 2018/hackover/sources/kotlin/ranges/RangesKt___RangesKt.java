...
class RangesKt___RangesKt extends RangesKt__RangesKt {
    ...
    public static final Byte toByteExactOrNull(long j) {
        return (((long) -128) <= j && ((long) 127) >= j) ? Byte.valueOf((byte) ((int) j)) : null;
    }
    ...
    public static final Byte toByteExactOrNull(double d) {
        return (d < ((double) -128) || d > ((double) 127)) ? null : Byte.valueOf((byte) ((int) d));
    }

    @Nullable
    public static final Byte toByteExactOrNull(float f) {
        return (f < ((float) -128) || f > ((float) 127)) ? null : Byte.valueOf((byte) ((int) f));
    }
    ...
    public static final Long toLongExactOrNull(float f) {
        return (f < ((float) Long.MIN_VALUE) || f > ((float) LongCompanionObject.MAX_VALUE)) ? null : Long.valueOf((long) f);
    }
    ...
    public static final Short toShortExactOrNull(long j) {
        return (((long) -32768) <= j && ((long) 32767) >= j) ? Short.valueOf((short) ((int) j)) : null;
    }

    @Nullable
    public static final Short toShortExactOrNull(double d) {
        return (d < ((double) -32768) || d > ((double) 32767)) ? null : Short.valueOf((short) ((int) d));
    }

    @Nullable
    public static final Short toShortExactOrNull(float f) {
        return (f < ((float) -32768) || f > ((float) 32767)) ? null : Short.valueOf((short) ((int) f));
    }
