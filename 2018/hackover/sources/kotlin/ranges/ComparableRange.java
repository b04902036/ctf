...
class ComparableRange<T extends Comparable<? super T>> implements ClosedRange<T> {
    ...
    /* JADX WARNING: Missing block: B:9:0x002f, code:
            if (kotlin.jvm.internal.Intrinsics.areEqual(getEndInclusive(), r3.getEndInclusive()) != false) goto L_0x0031;
     */
    ...
    L_0x0013:
        ...
        if (r0 == 0) goto L_0x0033;
    L_0x0023:
        r2 = r2.getEndInclusive();
        r3 = r3.getEndInclusive();
        r2 = kotlin.jvm.internal.Intrinsics.areEqual(r2, r3);
