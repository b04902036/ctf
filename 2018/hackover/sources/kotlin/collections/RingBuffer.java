...
final class RingBuffer<T> extends AbstractList<T> implements RandomAccess {
    ...
    public T get(int i) {
        AbstractList.Companion.checkElementIndex$kotlin_stdlib(i, access$getSize$p());
        return this.buffer[(this.startIndex + i) % getCapacity()];
    }

    public final boolean isFull() {
        return access$getSize$p() == this.capacity;
    }
    ...
    public <T> T[] toArray(@NotNull T[] tArr) {
        ...
        if (tArr.length < access$getSize$p()) {
            tArr = Arrays.copyOf(tArr, access$getSize$p());
            Intrinsics.checkExpressionValueIsNotNull(tArr, "java.util.Arrays.copyOf(this, newSize)");
        }
        int size = access$getSize$p();
        int i = 0;
    ...
    public Object[] toArray() {
        return toArray(new Object[access$getSize$p()]);
    }
    ...
    public final void add(T t) {
        ...
        this.buffer[(this.startIndex + access$getSize$p()) % getCapacity()] = t;
        setSize(access$getSize$p() + 1);
    }

    public final void removeFirst(int i) {
        int i2 = 1;
        if ((i >= 0 ? 1 : 0) != 0) {
            if (i > access$getSize$p()) {
                i2 = 0;
            }
            if (i2 == 0) {
                StringBuilder stringBuilder = new StringBuilder();
                ...
                stringBuilder.append(access$getSize$p());
                throw new IllegalArgumentException(stringBuilder.toString().toString());
            } else if (i > 0) {
                i2 = this.startIndex;
        ...
        stringBuilder2.append("n shouldn't be negative but it is ");
