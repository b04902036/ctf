...
public final class ArraysKt___ArraysJvmKt$asList$1 extends AbstractList<Byte> implements RandomAccess {
    ...
    public boolean contains(byte b) {
        return ArraysKt___ArraysKt.contains(this.receiver$0, b);
    }
    ...
    public int indexOf(byte b) {
        return ArraysKt___ArraysKt.indexOf(this.receiver$0, b);
    }

    public int lastIndexOf(byte b) {
        return ArraysKt___ArraysKt.lastIndexOf(this.receiver$0, b);
    }
}
