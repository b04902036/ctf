...
public final class ArraysKt___ArraysJvmKt$asList$3 extends AbstractList<Integer> implements RandomAccess {
    ...
    public boolean contains(int i) {
        return ArraysKt___ArraysKt.contains(this.receiver$0, i);
    }
    ...
    public int indexOf(int i) {
        return ArraysKt___ArraysKt.indexOf(this.receiver$0, i);
    }

    public int lastIndexOf(int i) {
        return ArraysKt___ArraysKt.lastIndexOf(this.receiver$0, i);
    }
}
