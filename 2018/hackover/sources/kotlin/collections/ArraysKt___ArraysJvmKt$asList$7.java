...
public final class ArraysKt___ArraysJvmKt$asList$7 extends AbstractList<Boolean> implements RandomAccess {
    ...
    public boolean contains(boolean z) {
        return ArraysKt___ArraysKt.contains(this.receiver$0, z);
    }
    ...
    public int indexOf(boolean z) {
        return ArraysKt___ArraysKt.indexOf(this.receiver$0, z);
    }

    public int lastIndexOf(boolean z) {
        return ArraysKt___ArraysKt.lastIndexOf(this.receiver$0, z);
    }
}
