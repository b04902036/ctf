...
class StringsKt__IndentKt {
        ...
        if ((StringsKt__StringsJVMKt.isBlank(str5) ^ 1) != 0) {
            ...
            for (Object obj : lines) {
                ...
                if ((i == 0 || i == lastIndex) && StringsKt__StringsJVMKt.isBlank((CharSequence) obj2)) {
                    ...
                    if (i3 != -1) {
                        int i5 = i3;
                        if (StringsKt__StringsJVMKt.startsWith$default(obj2, str3, i3, false, 4, null)) {
                            i3 = i5 + str3.length();
                            if (obj2 != null) {
    ...
    private static final String reindent$StringsKt__IndentKt(@NotNull List<String> list, int i, Function1<? super String, String> function1, Function1<? super String, String> function12) {
        ...
        String stringBuilder = ((StringBuilder) CollectionsKt___CollectionsKt.joinTo$default((List) arrayList, new StringBuilder(i), "\n", null, null, 0, null, null, 124, null)).toString();
        Intrinsics.checkExpressionValueIsNotNull(stringBuilder, "mapIndexedNotNull { inde…\"\\n\")\n        .toString()");
