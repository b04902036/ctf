...
class StringsKt__StringsJVMKt extends StringsKt__StringNumberConversionsKt {
    ...
    public static final String replaceFirst(@NotNull String str, char c, char c2, boolean z) {
        ...
        int indexOf$default = StringsKt__StringsKt.indexOf$default(charSequence, c, 0, z, 2, null);
        return indexOf$default < 0 ? str : StringsKt__StringsKt.replaceRange(charSequence, indexOf$default, indexOf$default + 1, (CharSequence) String.valueOf(c2)).toString();
    }
    ...
    public static final String replaceFirst(@NotNull String str, @NotNull String str2, @NotNull String str3, boolean z) {
        ...
        CharSequence charSequence = str;
        int indexOf$default = StringsKt__StringsKt.indexOf$default(charSequence, str2, 0, z, 2, null);
        return indexOf$default < 0 ? str : StringsKt__StringsKt.replaceRange(charSequence, indexOf$default, str2.length() + indexOf$default, (CharSequence) str3).toString();
    }
    ...
    public static final List<String> split(@NotNull CharSequence charSequence, @NotNull Pattern pattern, int i) {
        ...
        if ((i >= 0 ? 1 : null) != null) {
            ...
            return ArraysKt___ArraysJvmKt.asList((Object[]) split);
        }
    ...
    public static final String repeat(@NotNull CharSequence charSequence, int i) {
        ...
        stringBuilder3.append("Count 'n' must be non-negative, but was ");
        stringBuilder3.append(i);
        stringBuilder3.append('.');
        throw new IllegalArgumentException(stringBuilder3.toString().toString());
    }
