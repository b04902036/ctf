...
public final class AndroidKeystoreKmsClient implements KmsClient {
    ...
    public static void generateNewAeadKey(String str) throws GeneralSecurityException {
        str = Validators.validateKmsKeyUriAndRemovePrefix(PREFIX, str);
        KeyGenerator instance = KeyGenerator.getInstance("AES", "AndroidKeyStore");
        instance.init(new Builder(str, 3).setKeySize(256).setBlockModes(new String[]{"GCM"}).setEncryptionPaddings(new String[]{"NoPadding"}).build());
