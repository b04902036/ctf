...
public final class Config {
    public static KeyTypeEntry getTinkKeyTypeEntry(String str, String str2, String str3, int i, boolean z) {
        ...
        stringBuilder.append("type.googleapis.com/google.crypto.tink.");
        stringBuilder.append(str3);
        return (KeyTypeEntry) primitiveName.setTypeUrl(stringBuilder.toString()).setKeyManagerVersion(i).setNewKeyAllowed(z).setCatalogueName(str).build();
    }
