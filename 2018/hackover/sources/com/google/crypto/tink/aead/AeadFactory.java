...
public final class AeadFactory {
    ...
    public static Aead getPrimitive(KeysetHandle keysetHandle, KeyManager<Aead> keyManager) throws GeneralSecurityException {
        ...
        return new Aead() {
            public byte[] encrypt(byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
                return Bytes.concat(primitives.getPrimary().getIdentifier(), ((Aead) primitives.getPrimary().getPrimitive()).encrypt(bArr, bArr2));
            }
     ...
     */
            ...
            return ((com.google.crypto.tink.Aead) ((com.google.crypto.tink.PrimitiveSet.Entry) r6.next()).getPrimitive()).decrypt(r7, r8);
     */
     ...
     */
            ...
            L_0x001e:
                ...
                r2 = (com.google.crypto.tink.Aead) r2;	 Catch:{ GeneralSecurityException -> 0x002f }
                r2 = r2.decrypt(r1, r8);	 Catch:{ GeneralSecurityException -> 0x002f }
                return r2;
            L_0x002f:
                r2 = move-exception;
                r3 = com.google.crypto.tink.aead.AeadFactory.logger;
            ...
            L_0x005d:
                ...
                r0 = (com.google.crypto.tink.Aead) r0;	 Catch:{ GeneralSecurityException -> 0x0057 }
            ...
            L_0x006e:
                ...
                throw r6;
                */
                throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.aead.AeadFactory.1.decrypt(byte[], byte[]):byte[]");
            }
        };
    }
    ...
    private static void validate(PrimitiveSet<Aead> primitiveSet) throws GeneralSecurityException {
        for (Collection<Entry> it : primitiveSet.getAll()) {
            for (Entry primitive : it) {
                if (!(primitive.getPrimitive() instanceof Aead)) {
