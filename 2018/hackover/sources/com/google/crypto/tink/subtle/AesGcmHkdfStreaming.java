...
public final class AesGcmHkdfStreaming extends NonceBasedStreamingAead {
    ...
    public AesGcmHkdfStreaming(byte[] bArr, String str, int i, int i2, int i3) throws InvalidAlgorithmParameterException {
        if (bArr.length < 16 || bArr.length < i) {
            ...
            stringBuilder.append(Math.max(16, i));
    ...
    private GCMParameterSpec paramsForSegment(byte[] bArr, int i, boolean z) {
    ...
    private SecretKeySpec deriveKeySpec(byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
