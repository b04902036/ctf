...
public final class EcdsaSignJce implements PublicKeySign {
    ...
    public byte[] sign(byte[] bArr) throws GeneralSecurityException {
        ...
        bArr = signature.sign();
        return this.encoding == EcdsaEncoding.IEEE_P1363 ? EllipticCurves.ecdsaDer2Ieee(bArr, EllipticCurves.fieldSizeInBytes(this.privateKey.getParams().getCurve()) * 2) : bArr;
    }
}
