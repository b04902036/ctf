...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    private void getDesiredAnchoredChildRectWithoutConstraints(View view, int i, Rect rect, Rect rect2, LayoutParams layoutParams, int i2, int i3) {
        ...
        if (absoluteGravity == 16) {
            absoluteGravity2 -= i3 / 2;
        } else if (absoluteGravity != 80) {
            absoluteGravity2 -= i3;
        }
        rect2.set(i4, absoluteGravity2, i2 + i4, i3 + absoluteGravity2);
    }
    ...
    private void layoutChildWithKeyline(View view, int i, int i2) {
        ...
        int max = Math.max(getPaddingTop() + layoutParams.topMargin, Math.min(i2, ((height - getPaddingBottom()) - measuredHeight) - layoutParams.bottomMargin));
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.isNestedScrollAccepted(i3)) {
                    ...
                    if (behavior != null) {
                        ...
                        if (i2 > 0) {
                            max = Math.max(i7, this.mTempIntPair[1]);
                        } else {
                            max = Math.min(i7, this.mTempIntPair[1]);
                        }
                        i6 = i4;
                        i7 = max;
                        i4 = 1;
