...
public class Toolbar extends ViewGroup {
    ...
    L_0x0018:
        ...
        r2 = r2.mContentInsetEndWithActions;
    ...
    private int layoutChildLeft(View view, int i, int[] iArr, int i2) {
        ...
        view.layout(i, childTop, i + measuredWidth, view.getMeasuredHeight() + childTop);
        return i + (measuredWidth + layoutParams.rightMargin);
    }
    ...
    private int layoutChildRight(View view, int i, int[] iArr, int i2) {
        ...
        int childTop = getChildTop(view, i2);
        int measuredWidth = view.getMeasuredWidth();
        view.layout(i - measuredWidth, childTop, i, view.getMeasuredHeight() + childTop);
        return i - (measuredWidth + layoutParams.leftMargin);
    }
