...
public final class LocalBroadcastManager {
    ...
    /* JADX WARNING: Missing block: B:52:0x0168, code:
            return true;
     */
    /* JADX WARNING: Missing block: B:55:0x016b, code:
            return false;
     */
    public boolean sendBroadcast(@android.support.annotation.NonNull android.content.Intent r22) {
        ...
        r3 = r0.mAppContext;	 Catch:{ all -> 0x016c }
        r3 = r3.getContentResolver();	 Catch:{ all -> 0x016c }
        r11 = r1.resolveTypeIfNeeded(r3);	 Catch:{ all -> 0x016c }
    ...
    L_0x0144:
        ...
        goto L_0x013e;
    L_0x0150:
        r3 = r0.mPendingBroadcasts;	 Catch:{ all -> 0x016c }
        r4 = new android.support.v4.content.LocalBroadcastManager$BroadcastRecord;	 Catch:{ all -> 0x016c }
        r4.<init>(r1, r10);	 Catch:{ all -> 0x016c }
        r3.add(r4);	 Catch:{ all -> 0x016c }
        r1 = r0.mHandler;	 Catch:{ all -> 0x016c }
        r1 = r1.hasMessages(r11);	 Catch:{ all -> 0x016c }
        if (r1 != 0) goto L_0x0167;
    L_0x0162:
        r0 = r0.mHandler;	 Catch:{ all -> 0x016c }
