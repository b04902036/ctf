...
public class IconCompat extends CustomVersionedParcelable {
    ...
    L_0x0009:
        ...
        r7 = r7.getResources();
        r6 = r6.mObj1;
        r6 = (android.graphics.Bitmap) r6;
        r6 = createLegacyIconFromAdaptiveIcon(r6, r1);
        r0.<init>(r7, r6);
        return r0;
    L_0x001b:
        r0 = r6.mObj1;
    ...
    L_0x0037:
        goto L_0x0060;
    L_0x0038:
        r1 = new java.io.FileInputStream;	 Catch:{ FileNotFoundException -> 0x0048 }
        r3 = new java.io.File;	 Catch:{ FileNotFoundException -> 0x0048 }
        r6 = r6.mObj1;	 Catch:{ FileNotFoundException -> 0x0048 }
        r6 = (java.lang.String) r6;	 Catch:{ FileNotFoundException -> 0x0048 }
    ...
    L_0x0048:
        ...
        goto L_0x0080;
    L_0x0060:
        r6 = r7.getContentResolver();	 Catch:{ Exception -> 0x0069 }
        r6 = r6.openInputStream(r0);	 Catch:{ Exception -> 0x0069 }
        goto L_0x0081;
    L_0x0069:
        r6 = move-exception;
        r1 = "IconCompat";
    ...
    L_0x0083:
        r0 = new android.graphics.drawable.BitmapDrawable;
        r7 = r7.getResources();
        r6 = android.graphics.BitmapFactory.decodeStream(r6);
        r0.<init>(r7, r6);
        return r0;
    L_0x0091:
        r0 = new android.graphics.drawable.BitmapDrawable;
        ...
        r2 = r6.mInt1;
        r6 = r6.mInt2;
        r6 = android.graphics.BitmapFactory.decodeByteArray(r1, r2, r6);
        r0.<init>(r7, r6);
        return r0;
    L_0x00a7:
        r0 = r6.getResPackage();
    ...
    L_0x00b5:
        ...
        r3 = r6.mInt1;	 Catch:{ RuntimeException -> 0x00c4 }
        r7 = r7.getTheme();	 Catch:{ RuntimeException -> 0x00c4 }
        r7 = android.support.v4.content.res.ResourcesCompat.getDrawable(r0, r3, r7);	 Catch:{ RuntimeException -> 0x00c4 }
        return r7;
    L_0x00c4:
        r7 = move-exception;
        r0 = "IconCompat";
        ...
        r6 = r6.mObj1;
        r4[r1] = r6;
        r6 = java.lang.String.format(r3, r4);
    ...
    public void addToShortcutIntent(@NonNull Intent intent, @Nullable Drawable drawable, @NonNull Context context) {
        ...
        if (drawable != null) {
            ...
            i = parcelable.getHeight();
            drawable.setBounds(width / 2, i / 2, width, i);
    ...
    private static String getResPackage(@NonNull Icon icon) {
        ...
        try {
            ...
            Log.e(TAG, "Unable to get icon package", e22);
            return null;
        }
    }
    ...
    private static int getResId(@NonNull Icon icon) {
        ...
        try {
            ...
            Log.e(TAG, "Unable to get icon resource", e22);
            return 0;
        }
    }
    ...
    private static Uri getUri(@NonNull Icon icon) {
        ...
        try {
            ...
            Log.e(TAG, "Unable to get icon uri", e22);
            return null;
        }
    }
