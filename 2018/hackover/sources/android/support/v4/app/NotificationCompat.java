...
public class NotificationCompat {
    ...
    public static abstract class Style {
        ...
        L_0x01ed:
            ...
            r15 = "setBase";
            r12 = r12.mBuilder;
            r0 = r12.getWhenIfShowing();
            r2 = android.os.SystemClock.elapsedRealtime();
            r4 = java.lang.System.currentTimeMillis();
            r2 = r2 - r4;
            r0 = r0 + r2;
            r7.setLong(r14, r15, r0);
            r12 = android.support.compat.R.id.chronometer;
            r14 = "setStarted";
        ...
        L_0x0223:
            r14 = r8;
        L_0x0224:
            r12 = android.support.compat.R.id.right_side;
        ...
        L_0x022b:
            ...
            r12 = android.support.compat.R.id.line3;
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (VERSION.SDK_INT >= 16) {
                ...
                for (int size = this.mMessages.size() - 1; size >= 0; size--) {
                    ...
                    text = i != 0 ? makeMessageLine(message3) : message3.getText();
                    if (size != this.mMessages.size() - 1) {
                        makeMessageLine.insert(0, "\n");
                    }
                    makeMessageLine.insert(0, text);
                }
